...
def status():
    ...
    if input_state :
        ...
        led_status = "On" 
    return """<html><body><div style="text-align: center;"><h2 style="text-align: center;"> %s or Off,click on it. </h2></br><span style="font-size:100px;color:#252525;"><a href="/off" >ON</a>  |  <a href="/on">OFF</a></span></div>""" % led_status
